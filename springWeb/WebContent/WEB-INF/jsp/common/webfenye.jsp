...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td width="12" height="35">
        <img src="${pageContext.servletContext.contextPath }/images/tab_18.gif" width="12" height="35" />
     </td>
     <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
             <td class="STYLE4">&nbsp;&nbsp;总的记录数:${pageView.rowCount}条|每页显示:${pageView.pageSize}条| 总页数:${pageView.pageCount}页
             </td>
             <td>
               <table border="0" align="right" cellpadding="0" cellspacing="0">
                   <tr>
                     ...
                     <td width="45" class="STYLE4">
                        <a href="#" onclick="return pageNow('${pageNow - 1}')">
                                                                               上一页
                        </a>
                     </td>
                     <td align = "center">
                       <c:foreach begin="${pageView.pageindex.startindex}" end="${pageView.pageindex.startindex}" var="key">
