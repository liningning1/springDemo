...
<div style="height: 100%;overflow-y: auto;">
		<br /> <br />
	<form action="${pageContext.servletContext.contextPath}/background/user/add.html" method="post">
	            ...
	            <tr>
	              <td colspan="4" style="padding: 10px">
	                 <div align="center">
	                    ...
	                    <input type="button" value="返回" class="input_btn_style1" onclick="javascript:window.location.href='javascript:history.go(-1)'"/>
	                 </div>
	              </td>
	            </tr>
	</table>
